...
class ResultsCell: UITableViewCell {
    ...
    @IBOutlet weak private var destinationIcon: UILabel!
    ...
    override func awakeFromNib() {
        ...
        destinationIcon.textColor = UIColor(rgb: 0x489773)
        ...
        destinationDistanceLabel.textColor = UIColor(rgb: 0x6D6D6D)
