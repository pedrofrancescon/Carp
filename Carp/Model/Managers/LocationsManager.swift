...
class LocationsManager: CLLocationManager, CLLocationManagerDelegate, GMSAutocompleteFetcherDelegate {
    ...
    private var predictionsUpdate: (([GMSAutocompletePrediction]) -> Void)?
    ...
    func getPlacePredictions(with text: String, _ completion: @escaping ([GMSAutocompletePrediction]) -> Void) {
